...
public class TestStockage {
	...
	public static void main(String[] args) {
		...
		Client<CompteEpargne> client1=new Client<CompteEpargne>("Bob", "Bradbord",Civilite.MADEMOISELLE, "4472");
		Client<Compte> client2=new Client<Compte>("Stanley", "Seiger", Civilite.MONSIEUR , "2237");
		Client<CompteCourant> client3=new Client<CompteCourant>("Frank", "Ferguson", Civilite.MADAME, "2356");
		...
		System.out.println(stock.retournerElement("Bob"));
